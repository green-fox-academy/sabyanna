...
public class Triangles {
    ...
    public static void triangles(Graphics g, int i, double magic, double MAGIC) {
        int xp[] = {(int)(wid * magic), (int)((wid+side/2) * magic), (int)((wid-side/2) * magic)};
        int yp[] = {0, (int)(hei * MAGIC), (int)(hei * MAGIC)};
        g.drawPolygon(xp,yp,3);
        i++;

        if (i < 6) {
            triangles(g, i, magic/2, MAGIC/2);
            //triangles(g, i, magic*5/2, MAGIC/2);
